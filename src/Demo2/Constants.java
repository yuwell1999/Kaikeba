...
public class Constants {
    public static int LOOP_MS = 5000;
    public static int MESSAGE_COUNT = 100;

    public static String BASE_TURING_URL = "https://api.jisuapi.com/iqa/query";
    public static String BASE_VIRUS_URL = "https://zaixianke.com/yq/info";
    public static String BASE_MSG_URL = "https://api.jisuapi.com/sms/send";
